...
func (h *userHandler) List(ctx *fiber.Ctx) error {
	...
	return helper.CustomResponse(ctx, users, customstatus.StatusOk.Message, customstatus.StatusOk.Code)
}
...
func (h *userHandler) Find(ctx *fiber.Ctx) error {
	...
	if err != nil {
		return helper.CustomResponse(ctx, nil, err.Error(), customstatus.ErrNotFound.Code)
	}
	return helper.CustomResponse(ctx, user, customstatus.StatusOk.Message, customstatus.StatusOk.Code)
}
...
func (h *userHandler) Create(ctx *fiber.Ctx) error {
	...
	return helper.CustomResponse(ctx, user, customstatus.StatusCreated.Message, statusCode)
}
...
func (h *userHandler) Update(ctx *fiber.Ctx) error {
	...
	return helper.CustomResponse(ctx, result, customstatus.StatusCreated.Message, statusCode)
